(function() {
	var APC_r_url = "http://jqmt.qq.com/rpt.png?plf=3&";
	var APC_count = 0,
		APC_idx = [],
		APC_task = [];
	...
	function APC_st(i, t) {
		...
		p.onload = function() {
			p.onload = null;
			APC_r_ok(this.idx, this.st, this.t)
		};
		p.onerror = function() {
			p.onerror = null;
			APC_r_err(this.idx, this.st, this.t)
		};
	...
	try {
		apc_CallBack({
			"rCount": 2,
			'11': 'http://qqhome2-item.qq.com/bz.gif',
			'46': 'http://vhot2.qqvideo.tc.qq.com/bz.gif'
		});
	} catch (e) {}
})();