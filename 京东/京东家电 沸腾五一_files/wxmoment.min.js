function require(t) {
    ...
    return "exports" in e || "function" != typeof e.definition || (e.client = e.component = !0, e.definition.call(this, e.exports = {},
    e), delete e.definition),
    e.exports
}
require.loader = "component",
require.helper = {},
require.helper.semVerSort = function(t, e) {
...
require.register("./lib/underscore",
function(t, e) { (function() {
        ...
        "undefined" != typeof t ? ("undefined" != typeof e && e.exports && (t = e.exports = g), t._ = g) : n._ = g,
        g.VERSION = "1.7.0";
        ...
        g.map = g.collect = function(t, e, n) {
            if (null == t) return [];
            e = g.iteratee(e, n);
            for (var r, i = t.length !== +t.length && g.keys(t), o = (i || t).length, a = Array(o), s = 0; o > s; s++) r = i ? i[s] : s,
            a[s] = e(t[r], r, t);
            return a
        };
        ...
        g.filter = g.select = function(t, e, n) {
            var r = [];
            return null == t ? r: (e = g.iteratee(e, n), g.each(t,
            function(t, n, i) {
                e(t, n, i) && r.push(t)
            }), r)
        },
        ...
        g.max = function(t, e, n) {
            ...
            if (null == e && null != t) {
                ...
                for (var s = 0,
                u = t.length; u > s; s++) r = t[s],
                r > o && (o = r)
            } else e = g.iteratee(e, n),
            g.each(t,
            function(t, n, r) {
                i = e(t, n, r),
        ...
        g.shuffle = function(t) {
            for (var e, n = t && t.length === +t.length ? t: g.values(t), r = n.length, i = Array(r), o = 0; r > o; o++) e = g.random(0, o),
            e !== o && (i[o] = i[e]),
            i[e] = n[o];
            return i
        },
        ...
        var x = function(t, e, n, r) {
            ...
            o = t.length; o > i; i++) {
                var a = t[i];
                g.isArray(a) || g.isArguments(a) ? e ? s.apply(r, a) : x(a, e, n, r) : n || r.push(a)
            }
            return r
        };
        ...
        g.difference = function(t) {
            var e = x(u.call(arguments, 1), !0, !0, []);
            return g.filter(t,
            function(t) {
        ...
        g.object = function(t, e) {
            ...
            for (var n = {},
            r = 0,
            i = t.length; i > r; r++) e ? n[t[r]] = e[r] : n[t[r][0]] = t[r][1];
            return n
        },
        g.indexOf = function(t, e, n) {
            ...
            i = t.length;
            if (n) {
                if ("number" != typeof n) return r = g.sortedIndex(t, e),
                t[r] === e ? r: -1;
        ...
        g.partial = function(t) {
            ...
            return function() {
                for (var n = 0,
                r = e.slice(), i = 0, o = r.length; o > i; i++) r[i] === g && (r[i] = arguments[n++]);
        ...
        g.memoize = function(t, e) {
            var n = function(r) {
                ...
                return g.has(i, o) || (i[o] = t.apply(this, arguments)),
                i[o]
            };
            return n.cache = {},
            n
        ...
        g.throttle = function(t, e, n) {
            ...
            return function() {
                ...
                return r = this,
                i = arguments,
                0 >= l || l > e ? (clearTimeout(a), a = null, s = c, o = t.apply(r, i), a || (r = i = null)) : a || n.trailing === !1 || (a = setTimeout(u, l)),
                o
            }
        },
        ...
        g.invert = function(t) {
            for (var e = {},
            n = g.keys(t), r = 0, i = n.length; i > r; r++) e[t[n[r]]] = n[r];
            return e
        },
        ...
        g.clone = function(t) {
            return g.isObject(t) ? g.isArray(t) ? t.slice() : g.extend({},
            t) : t
        },
        g.tap = function(t, e) {
            return e(t),
        ...
        var w = function(t, e, n, r) {
            ...
            var u, c;
            if ("[object Array]" === i) {
                if (u = t.length, c = u === e.length) for (; u--&&(c = w(t[u], e[u], n, r)););
            } else {
                var f, h = g.keys(t);
                if (u = h.length, c = g.keys(e).length === u) for (; u--&&(f = h[u], c = g.has(e, f) && w(t[f], e[f], n, r)););
            }
            return n.pop(),
            r.pop(),
            c
        ...
        g.each(["Arguments", "Function", "String", "Number", "Date", "RegExp"],
        function(t) {
            g["is" + t] = function(e) {
        ...
        g.template = function(t, e, n) { ! e && n && (e = n),
            e = g.defaults({},
            e, g.templateSettings);
            var r = RegExp([(e.escape || k).source, (e.interpolate || k).source, (e.evaluate || k).source].join("|") + "|$", "g"),
            i = 0,
            o = "__p+='";
            t.replace(r,
            function(e, n, r, a, s) {
                return o += t.slice(i, s).replace(j, q),
                i = s + e.length,
        ...
        g.mixin = function(t) {
            g.each(g.functions(t),
            function(e) {
                var n = g[e] = t[e];
                g.prototype[e] = function() {
                    var t = [this._wrapped];
                    return s.apply(t, arguments),
                    C.call(this, n.apply(g, t))
                }
            })
        },
        g.mixin(g),
        g.each(["pop", "push", "reverse", "shift", "sort", "splice", "unshift"],
        function(t) {
            var e = i[t];
...
function(t, e) {
    ...
    r = function() {
        ...
        function h(t) {
            var e, n;
            return D[t] || (e = C.createElement(t), C.body.appendChild(e), n = getComputedStyle(e, "").getPropertyValue("display"), e.parentNode.removeChild(e), "none" == n && (n = "block"), D[t] = n),
            D[t]
        }
        function p(t) {
            return "children" in t ? j.call(t.children) : S.map(t.childNodes,
            function(t) {
                return 1 == t.nodeType ? t: void 0
            })
        }
        function d(t, e, n) {
            for (E in e) n && (o(e[E]) || Z(e[E])) ? (o(e[E]) && !o(t[E]) && (t[E] = {}), Z(e[E]) && !Z(t[E]) && (t[E] = []), d(t[E], e[E], n)) : e[E] !== w && (t[E] = e[E])
        }
        function g(t, e) {
        ...
        W = C.createElement("table"),
        F = C.createElement("tr"),
        U = {
        ...
        X.fragment = function(t, e, n) {
            var r, i, a;
            return M.test(t) && (r = S(C.createElement(RegExp.$1))),
            r || (t.replace && (t = t.replace(P, "<$1></$2>")), e === w && (e = L.test(t) && RegExp.$1), e in U || (e = "*"), a = U[e], a.innerHTML = "" + t, r = S.each(j.call(a.childNodes),
            function() {
                a.removeChild(this)
            })),
            o(n) && (i = S(r), S.each(n,
        ...
        X.init = function(t, n) {
            var r;
            if (!t) return X.Z();
            if ("string" == typeof t) if (t = t.trim(), "<" == t[0] && L.test(t)) r = X.fragment(t, RegExp.$1, n),
            t = null;
            else {
                if (n !== w) return S(n).find(t);
                r = X.qsa(C, t)
            } else {
                if (e(t)) return S(C).ready(t);
                if (X.isZ(t)) return t;
                if (Z(t)) r = s(t);
                else if (i(t)) r = [t],
                t = null;
                else if (L.test(t)) r = X.fragment(t.trim(), RegExp.$1, n),
                t = null;
                else {
                    if (n !== w) return S(n).find(t);
                    r = X.qsa(C, t)
        ...
        X.qsa = function(t, e) {
            ...
            a = i || o ? e.slice(1) : e,
            s = G.test(a);
            return r(t) && s && i ? (n = t.getElementById(a)) ? [n] : [] : 1 !== t.nodeType && 9 !== t.nodeType ? [] : j.call(s && !i ? o ? t.getElementsByClassName(a) : t.getElementsByTagName(e) : t.querySelectorAll(e))
        },
        S.contains = C.documentElement.contains ?
        function(t, e) {
        ...
        S.fn = {
            ...
            slice: function() {
                return S(j.apply(this, arguments))
            },
            ready: function(t) {
                return z.test(C.readyState) && C.body ? t(S) : C.addEventListener("DOMContentLoaded",
                function() {
                    t(S)
                },
                !1),
            ...
            filter: function(t) {
                return e(t) ? this.not(this.not(t)) : S(q.call(this,
                function(e) {
            ...
            not: function(t) {
                ...
                if (e(t) && t.call !== w) this.each(function(e) {
                    ...
                    var r = "string" == typeof t ? this.filter(t) : a(t) && e(t.item) ? j.call(t) : S(t);
            ...
            closest: function(t, e) {
                var n = this[0],
                i = !1;
                for ("object" == typeof t && (i = S(t)); n && !(i ? i.indexOf(n) >= 0 : X.matches(n, t));) n = n !== e && !r(n) && n.parentNode;
                return S(n)
            },
            parents: function(t) {
            ...
            toggle: function(t) {
                return this.each(function() {
                    var e = S(this); (t === w ? "none" == e.css("display") : t) ? e.show() : e.hide()
                })
            },
            prev: function(t) {
            ...
            css: function(e, n) {
                if (arguments.length < 2) {
                    var r, i = this[0];
                    if (!i) return;
                    if (r = getComputedStyle(i, ""), "string" == typeof e) return i.style[_(e)] || r.getPropertyValue(e);
                    if (Z(e)) {
                        var o = {};
                        return S.each(e,
                        function(t, e) {
            ...
            offsetParent: function() {
                return this.map(function() {
                    for (var t = this.offsetParent || C.body; t && !I.test(t.nodeName) && "static" == S(t).css("position");) t = t.offsetParent;
                    return t
                })
            }
        },
        ...
        B.forEach(function(e, n) {
            ...
            S.fn[e] = function() {
                ...
                return o.length < 1 ? this: this.each(function(t, e) {
                    ...
                    var s = S.contains(C.documentElement, i);
    ...
    window.Zepto = r,
    e.exports = void 0 === window.$ && (window.$ = r),
    function(t) {
        function e(t) {
    ...
    function(t) {
        ...
        t.ajax = function(e) {
            ...
            r(i),
            i.crossDomain || (n = y.createElement("a"), n.href = i.url, n.href = n.href, i.crossDomain = _.protocol + "//" + _.host != n.protocol + "//" + n.host),
            i.url || (i.url = window.location.toString()),
            h(i);
            var p = i.dataType,
            d = /\?.+=\?/.test(i.url);
            if (d && (p = "jsonp"), i.cache !== !1 && (e && e.cache === !0 || "script" != p && "jsonp" != p) || (i.url = f(i.url, "_=" + Date.now())), "jsonp" == p) return d || (i.url = f(i.url, i.jsonp ? i.jsonp + "=?": i.jsonp === !1 ? "": "callback=?")),
            t.ajaxJSONP(i, u);
            var v, x = i.accepts[p],
            b = {},
            w = function(t, e) {
            ...
            if (u && u.promise(S), i.crossDomain || w("X-Requested-With", "XMLHttpRequest"), w("Accept", x || "*/*"), (x = i.mimeType || x) && (x.indexOf(",") > -1 && (x = x.split(",", 2)[0]), S.overrideMimeType && S.overrideMimeType(x)), (i.contentType || i.contentType !== !1 && i.data && "GET" != i.type.toUpperCase()) && w("Content-Type", i.contentType || "application/x-www-form-urlencoded"), i.headers) for (m in i.headers) w(m, i.headers[m]);
            if (S.setRequestHeader = w, S.onreadystatechange = function() {
                if (4 == S.readyState) {
                    ...
                    if (S.status >= 200 && S.status < 300 || 304 == S.status || 0 == S.status && "file:" == E) {
                        p = p || l(i.mimeType || S.getResponseHeader("content-type")),
                        e = S.responseText;
                        try {
                            "script" == p ? (1, eval)(e) : "xml" == p ? e = S.responseXML: "json" == p && (e = T.test(e) ? null: t.parseJSON(e))
                        } catch(r) {
                            n = r
                        }
                        n ? s(n, "parsererror", S, i, u) : a(e, S, i, u)
                    } else s(S.statusText || null, S.status ? "error": "abort", S, i, u)
                }
            },
            o(S, i) === !1) return S.abort(),
            s(null, "abort", S, i, u),
            S;
            if (i.xhrFields) for (m in i.xhrFields) S[m] = i.xhrFields[m];
            var A = "async" in i ? i.async: !0;
            S.open(i.type, i.url, A, i.username, i.password);
            for (m in b) k.apply(S, b[m]);
            return i.timeout > 0 && (v = setTimeout(function() {
                S.onreadystatechange = c,
                S.abort(),
                s(null, "timeout", S, i, u)
            },
            i.timeout)),
...
require.register("./lib/zepto/touch.js",
function(t, e) {
    e.exports = function(t) {
        ...
        t(document).ready(function() {
            ...
            function(e) { (!(v = a(e, "down")) || o(e)) && (m = v ? e: e.touches[0], e.touches && 1 === e.touches.length && h.x2 && (h.x2 = void 0, h.y2 = void 0), d = Date.now(), g = d - (h.last || d), h.el = t("tagName" in m.target ? m.target: m.target.parentNode), s && clearTimeout(s), h.x1 = m.pageX, h.y1 = m.pageY, g > 0 && 250 >= g && (h.isDoubleTap = !0), h.last = d, l = setTimeout(n, p), f && v && f.addPointer(e.pointerId))
            }).on("touchmove MSPointerMove pointermove",
            function(t) { (!(v = a(t, "move")) || o(t)) && (m = v ? t: t.touches[0], r(), h.x2 = m.pageX, h.y2 = m.pageY, y += Math.abs(h.x1 - h.x2), x += Math.abs(h.y1 - h.y2))
...
require.register("./lib/analytics",
function(t, e) {
    function n(t) {
        r.setConfig(t);
        ...
        n.async = "true",
        n.src = "https:" == location.protocol ? "https://pingjs.qq.com/tcss.ping.https.js": "http://pingjs.qq.com/tcss.ping.js";
        var i = !1;
    ...
    var r = require("./lib/analytics/analyticsCommon.js");
    n.prototype.sendEvent = function(t, e) {
        r.sendEvent(t, e, r.config.projectName)
    },
    e.exports = n
}),
require.register("./lib/analytics/analyticsCommon.js",
function(t, e) {
    function n(t, e, n) {
        var r, i, a, s = "//isdspeed.qq.com/cgi-bin/r.cgi",
        u = ["navigationStart", "unloadEventStart", "unloadEventEnd", "redirectStart", "redirectEnd", "fetchStart", "domainLookupStart", "domainLookupEnd", "connectStart", "connectEnd", "requestStart", "responseStart", "responseEnd", "domLoading", "domInteractive", "domContentLoadedEventStart", "domContentLoadedEventEnd", "domComplete", "loadEventStart", "loadEventEnd"],
        c = [];
        if (o && (r = o.timing)) {
            r.domContentLoadedEventStart || u.splice(15, 2, "domContentLoaded", "domContentLoaded"),
            i = r[u[0]];
            for (var l = 1,
            f = u.length; f > l; l++) a = r[u[l]],
            a = a ? a - i: 0,
            a > 0 && c.push(l + "=" + a);
            var h = s + "?flag1=" + t + "&flag2=" + e + "&flag3=" + n + "&" + c.join("&");
            return h
        }
    }
    function r(t, e, n) {
    ...
    function i() {
        var t = o ? o.timing.domComplete: a,
        e = (new Date).getTime() - t;
        if (e = Math.ceil(e / 1e3), e > 0) {
            var n = "0-2s";
            e > 2 && 5 > e ? n = "2-5s": e > 5 && 10 > e ? n = "5-10s": e > 10 && 15 > e ? n = "10-15s": e > 15 && 30 > e ? n = "15-30s": e > 30 && 60 > e ? n = "30-60s": e > 60 && 120 > e ? n = "60-120s": e > 120 && 300 > e ? n = "120-300s": e > 300 && (n = ">300s"),
            s.sendEventOnce(n, e, s.config.projectName + "Leaving")
        }
    }
    var o = window.webkitPerformance ? window.webkitPerformance: window.msPerformance;
    ...
    s = {
        ...
        sendEvent: function(t, e, n) {
            var r = this;
            if ("function" == typeof pgvSendClick && n)"" !== t && "" !== e && pgvSendClick({
                hottag: "WXM." + n + "." + t + "." + e
            });
            else var i = setInterval(function() {
                n = n || r.config.projectName,
                "function" == typeof pgvSendClick && n && (clearInterval(i), "" !== t && "" !== e && pgvSendClick({
                    hottag: "WXM." + n + "." + t + "." + e
                }))
            },
            200)
        ...
        sendEventOnce: function(t, e, n) {
            n = n || this.config.projectName,
            "function" == typeof pgvSendClick && n && "" !== t && "" !== e && pgvSendClick({
                hottag: "WXM." + n + "." + t + "." + e
            })
        }
    };
    ...
    var u = function() {
        ...
        function(t) {
            ...
            n = e && e.length > 1 && e[1];
            s.sendEvent("networkWxm", n)
        })
    };
    r(document, "WeixinJSBridgeReady", u),
    function() {
        var t = location.search.substr(1).match(/(^|&)from=([^&]*)(&|$)/);
        t && t[2] && s.sendEvent("pvWxm", t[2])
    } (),
    e.exports = s
}),
require.register("./lib/loader",
function(t, e) {
    function n(t) {
        t = t || {},
        this.settings = t,
        ...
        u = function() {
            var t = Math.ceil(((new Date).getTime() - e) / 1e3);
            if (t > 0) {
                var n = "0-2s";
                t > 2 && 5 > t ? n = "2-5s": t > 5 && 10 > t ? n = "5-10s": t > 10 && 15 > t ? n = "10-15s": t > 15 && 30 > t ? n = "15-30s": t > 30 && 60 > t ? n = "30-60s": t > 60 && 120 > t ? n = "60-120s": t > 120 && 300 > t ? n = "120-300s": t > 300 && (n = ">300s"),
                o.sendEvent(n, t, o.config.projectName + "Loading")
            }
        },
        c = function(t) {
        ...
        this.addCompletionListener = function(t, e) {
            i.push({
                tags: new r(e),
                callback: function(e) {
                    e.completedCount === e.totalCount && (t(e), u())
                }
            })
        };
        var l = function(t) {
            ...
            var e = function(e) {
                ...
                r = 1 / 0,
                i = 0; i < n.tags.length; i++) for (var o = 0; o < Math.min(t.length, r) && !(n.tags.all[i] === t[o] && r > o && (r = o, 0 === r)) && 0 !== r; o++);
                return r
            };
            return function(t, n) {
                var r = e(t),
        ...
        var f = function() {
            for (var e = !1,
            r = Date.now() - a, i = r >= t.noProgressTimeout, o = r >= t.loggingDelay, u = 0, c = n.length; c > u; u++) {
                var l = n[u];
                l.status === s.WAITING && (l.resource.checkStatus && l.resource.checkStatus(), l.status === s.WAITING && (i ? l.resource.onTimeout() : e = !0))
            }
            o && e && d(),
            e && setTimeout(f, t.statusInterval)
        };
        this.isBusy = function() {
            for (var t = 0,
            e = n.length; e > t; t++) if (n[t].status === s.QUEUED || n[t].status === s.WAITING) return ! 0;
            return ! 1
        };
        var h = function(t, e) {
            var r, o, u, c, l, f = null;
            for (r = 0, o = n.length; o > r; r++) if (n[r].resource === t) {
                f = n[r];
                break
            }
            if (null != f && f.status === s.WAITING) for (f.status = e, a = Date.now(), u = t.tags.length, r = 0, o = i.length; o > r; r++) c = i[r],
            l = 0 === c.tags.length ? !0 : t.tags.intersects(c.tags),
            l && p(f, c)
        };
        ...
        var p = function(t, e) {
            var r, i, o, a, u = 0,
            c = 0;
            for (r = 0, i = n.length; i > r; r++) o = n[r],
            a = !1,
            a = 0 === e.tags.length ? !0 : o.resource.tags.intersects(e.tags),
            a && (c++, (o.status === s.LOADED || o.status === s.ERROR || o.status === s.TIMEOUT) && u++);
            e.callback({
                resource: t.resource,
                loaded: t.status === s.LOADED,
                error: t.status === s.ERROR,
                timeout: t.status === s.TIMEOUT,
                completedCount: u,
                totalCount: c
            })
        },
        d = this.log = function(t) {
            if (window.console) {
                ...
                o = n.length; o > i; i++) {
                    var a = n[i];
                    if (t || a.status === s.WAITING) {
                        var u = "PxLoader: #" + i + " " + a.resource.getName();
                        switch (a.status) {
                        case s.QUEUED:
                            u += " (Not Started)";
                            break;
                        ...
                        a.resource.tags.length > 0 && (u += " Tags: [" + a.resource.tags.all.join(",") + "]"),
    ...
    o = require("./lib/analytics/analyticsCommon.js");
    ...
    "function" == typeof define && define.amd && define("PxLoader", [],
    function() {
        return n
    }),
...
require.register("./lib/loader/PxLoaderImage.js",
function(t, e) {
    function n(t, e, n, r) {
        var i = this,
        o = null;
...
require.register("./lib/orientation-tip",
function(t, e) {
    var n = require("./lib/zepto"),
    r = require("./lib/orientation-tip/template.html");
    e.exports = function() {
        n("#qr-box__img").length || n("body").append(r),
        Zepto(function(t) {
            var e = t('meta[name="wxm:link"]').attr("content");
            e || (e = window.location.href),
            e = encodeURIComponent(e),
            t("#qr-box__img").attr("style", "background-image:url(https://game.weixin.qq.com/cgi-bin/comm/qrcode?s=10&m=1&d=" + e + ")");
            var n = t('meta[name="wxm:img_url"]').attr("content");
            n && t("#qr-box__thumb").attr("style", "background-image:url(" + n + ")")
        })
    }
}),
...
require.register("./lib/page-slider",
function(t, e) {
    function n(t) {
        if ($.extend(this, f, t), this.pages.length <= 0) throw new Error("target para not pass");
        this.target = this.pages.eq(0).parent(),
        this.length = this.pages.length,
        this.moveTo = n.prototype.moveTo,
        this.index = 0,
        this.timer = null,
        ("vertical" === this.direction || "v" === this.direction) && (this.direction = "v"),
        ("horizontal" === this.direction || "h" === this.direction) && (this.direction = "h"),
        this.length <= 1 || this._init()
    }
    var r, i, o, a, s, u, c, l = require("./lib/analytics/analyticsCommon.js"),
    f = {
        direction: "vertical",
    ...
    n.prototype = {
        _init: function() {
            ...
            this.pages.each(function() {
                var t = $(this),
                e = t.wrapInner('<div class="PageSlider__wraper"></div>').find(".PageSlider__wraper"),
                n = e.height();
                n > p && (t.data("height", n), t.css("overflow", "auto")),
                e.children().unwrap()
            }),
            "h" === this.direction && this.pages.css("float", "left"),
            this.hasDot && this._createDot(),
            t._bindAnimation(),
            this.target.on("touchstart",
            function(e) {
                t._startHandle(e)
            }),
            this.target.on("touchmove",
            function(e) {
                t._moveHandle(e)
            }),
            this.target.on("touchend",
            function(e) {
                t._endHandle(e)
            }),
            $(window).on("resize",
            ...
            this.rememberLastVisited && (this.lastVisitedIndex = this._getLastVisited()),
        ...
        _startHandle: function(t) {
            var e = t.touches[0];
            if ("running" === a) return void t.preventDefault();
            if (s = "v" === this.direction ? e.clientY: e.clientX, r = this.pages.eq(this.index), i = r.data("lock-next"), o = r.data("lock-prev"), r[0].pageScrollHeight = r.data("height"), r[0].pageScrollHeight && (this.preventDefault = !1, c = p + r.scrollTop()), this.gestureFollowing) {
                var n = this.target.css("-webkit-transform").match(/translate\((-?\d+)px,\s+(-?\d+)px.*\)/);
                u = parseFloat("v" === this.direction ? n[2] : n[1])
            }
        },
        _moveHandle: function(t) {
            var e, n, l = t.changedTouches[0];
            return "running" === a ? void t.preventDefault() : (n = "v" === this.direction ? l.clientY: l.clientX, e = n - s, r[0].pageScrollHeight && (e > 0 && c === p && t.preventDefault(), 0 > e && c === r[0].pageScrollHeight && t.preventDefault()), this.gestureFollowing ? this.index <= 0 && n > s || this.index >= this.length - 1 && s > n ? void t.preventDefault() : e > 0 && o || 0 > e && i ? void t.preventDefault() : (e = u + e + "px", this._removeTransition(), "v" === this.direction ? this.target.css("-webkit-transform", "translate(0, " + e + ")") : this.target.css("-webkit-transform", "translate(" + e + ", 0)"), void this._preventDefault(t)) : void this._preventDefault(t))
        },
        _endHandle: function(t) {
            var e, n, u = t.changedTouches[0];
            if ("running" === a) return void t.preventDefault();
            if (n = "v" === this.direction ? u.clientY: u.clientX, e = n - s, this._setTransition(), e > 0 && ("v" === this.direction ? this.onSwipeDown.call(this) : this.onSwipeRight.call(this), !o)) {
                if (r[0].pageScrollHeight && c > p) return;
                e > 20 ? this.prev() : this.moveTo(this.index)
            }
            if (0 > e && ("v" === this.direction ? this.onSwipeUp.call(this) : this.onSwipeLeft.call(this), !i)) {
                if (r[0].pageScrollHeight && c < r[0].pageScrollHeight) return; - 20 > e ? this.next() : this.moveTo(this.index)
            }
        },
        moveTo: function(t, e) {
            var n, i = this;
            ...
            e = e || !1;
            var o, s;
            return Math.abs(t - this.index) > 1 ? o = "pageSliderMoveWxm": t - this.index > 0 ? o = "pageSliderDownWxm": t - this.index < 0 ? o = "pageSliderUpWxm": t - this.index == 0 && (o = "pageResizeWxm"),
            s = t >= this.length ? "bottom": 0 > t ? "top": this.index + "to" + t,
            l.sendEvent(o, s),
            t >= this.length || 0 > t ? void(a = "end") : (e && this._removeTransition(), this.onbeforechange.call(this), "v" === this.direction && (n = -t * p + "px", this.target.css("-webkit-transform", "translate(0, " + n + ")")), "h" === this.direction && (n = -t * h + "px", this.target.css("-webkit-transform", "translate(" + n + ", 0)")), clearTimeout(this.timer), void(this.timer = setTimeout(function() {
                i._currentClass(t),
                i.prevIndex = i.index,
                i.index = t,
                i.onchange.call(i),
                e && i._setTransition(),
                r && r[0].pageScrollHeight && (i.preventDefault = !0, r.scrollTop(0)),
                i.rememberLastVisited && i._saveLastVisited(),
                a = "end",
        ...
        _currentClass: function(t) {
            var e = this.currentClass;
            this.pages.eq(t).addClass(e),
            t === this.index || this.animationPlayOnce || this.pages.eq(this.index).removeClass(e)
        },
        _reset: function() {
            ...
            "v" === t && (this.target.width(h + "px"), this.target.height(p * this.length + "px")),
            "h" === t && (this.target.width(h * this.length + "px"), this.target.height(p + "px"))
        },
        _createDot: function() {
            for (var t = "",
            e = 0; e < this.length; e++) t += "<li>" + (e + 1) + "</li>";
            $(t).appendTo(this.target).wrapAll('<ul class="dot-list">');

        },
        _saveLastVisited: function() {
            var t = window.localStorage;
            t && t.setItem("pageSliderIndex", this.index)
        },
        _getLastVisited: function() {
            var t = window.localStorage;
            return t ? (this.cacheIndex = t.getItem("pageSliderIndex"), parseInt(this.cacheIndex)) : void 0
        },
        _bindAnimation: function() {
            var t = this,
            e = "<style>";
            $("[data-animation]").each(function(n) {
                var r = $(this),
                i = r.data("animation"),
                o = i.name,
                a = i.duration || 500,
                s = i.delay || 0,
                u = i["timing-function"] || "ease",
                c = i["fill-mode"] || "both",
                l = i["iteration-count"] || 1;
                r.data("animationid", ++n),
                e += "." + t.currentClass + ' [data-animationid="' + n + '"]{-webkit-animation-name: ' + o + ";-webkit-animation-duration: " + a + "ms;-webkit-animation-delay: " + s + "ms;-webkit-animation-timing-function: " + u + ";-webkit-animation-fill-mode: " + c + ";-webkit-animation-iteration-count: " + l + ";}"
            }),
            $("head").eq(0).append(e)
        },
...
function(t, e) {
    ...
    n.prototype.init = function(t) {
        ...
        t, this.config),
        this.config.timeline = i.extend({},
        this.config.global, this.config.timeline),
        this.config.appmessage = i.extend({},
        this.config.global, this.config.appmessage);
        var e = this,
        n = function() {
            WeixinJSBridge.on("menu:share:appmessage",
            function() {
                WeixinJSBridge.invoke("sendAppMessage", e.config.appmessage,
                function(t) {
                    "send_app_msg:cancel" !== t.err_msg && i.isFunction(e.config.appmessage.success) ? (e.config.appmessage.success(), o.sendEvent("shareAppmessageWxm", "success")) : i.isFunction(e.config.appmessage.cancel) && (e.config.appmessage.cancel(), o.sendEvent("shareAppmessageWxm", "cancel"))
                })
            }),
            WeixinJSBridge.on("menu:share:timeline",
            function() {
                WeixinJSBridge.invoke("shareTimeline", e.config.timeline,
                function(t) {
                    "share_timeline:cancel" !== t.err_msg && i.isFunction(e.config.timeline.success) ? (e.config.timeline.success(), o.sendEvent("shareTimelineWxm", "success")) : i.isFunction(__this._this.config.timeline.cancel) && (e.config.timeline.cancel(), o.sendEvent("shareTimelineWxm", "cancel"))
                })
            })
        };
    ...
    n.prototype.set = function() {
        3 === arguments.length && i.isString(arguments[0]) && i.isString(arguments[1]) ? this.config[arguments[0]][arguments[1]] = arguments[2] : console.log("[WxMoment Share] set 函数参数错误")
    },
    e.exports = n
}),
require.register("./lib/video",
function(t, e) {
    function n(t, e) {
        return s = u.extend({
            vid: null,
        ...
        t),
        s.oninited = function() {
            c.sendEvent("videoWxm", "oninited"),
            "function" == typeof t.oninited && t.oninited()
        },
        s.onplaying = function() {
            c.sendEvent("videoWxm", "onplaying"),
            "function" == typeof t.onplaying && t.onplaying()
        },
        s.onpause = function() {
            c.sendEvent("videoWxm", "onpause"),
            "function" == typeof t.onpause && t.onpause()
        },
        s.onresume = function() {
            c.sendEvent("videoWxm", "onresume"),
            "function" == typeof t.onresume && t.onresume()
        },
        s.onallended = function() {
            c.sendEvent("videoWxm", "onallended"),
            "function" == typeof t.onallended && t.onallended()
        },
        s.onfullscreen = function(e) {
            c.sendEvent("videoWxm", "onfullscreen"),
            "function" == typeof t.onfullscreen && t.onfullscreen()
        },
        s.vid ? (r(), a) : void console.log("请设置视频 vid")
    }
    function r() {
        var t = document.getElementsByTagName("head")[0] || document.documentElement,
        e = document.createElement("script");
        e.async = "true",
        e.src = "//imgcache.gtimg.cn/tencentvideo_v1/tvp/js/tvp.player_v2_zepto.js";
        var n = !1;
    ...
    c = require("./lib/analytics/analyticsCommon.js");
    n.prototype.getPlayer = function() {
        return a
    },
    e.exports = n
}),
require.register("./lib/form",
function(t, e) {
    function n(t, e) {
        this.data = {
            action: "submit"
        ...
        $.extend(this.data, t),
        this.url = e || "//mp.weixin.qq.com/promotion/cgi-bin/questionnaire"
    }
...
function(t, e) {
    ...
    e.exports = window.WxMoment = new l
}),
